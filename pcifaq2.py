...
with open("faq_info.csv", "w", newline='', encoding='utf-8') as f:
...
for item in data:
    filename = re.sub(r'[\\/*?:"<>|]', "", item["title"]) + ".txt"
    with open(os.path.join("faqs", filename), "w", encoding='utf-8') as f:
        f.write(item["content"])

print(f"Total de {len(data)} registros salvos em faq_info.xlsx, faq_info.csv, e arquivos de texto na pasta 'faqs'")
